...
sourceCpp('BTRR_harm_long_Rcpp_v4.cpp')
...
# # Get Results -------------------------------------------------------------
# 
# res_harm = res_harm_A # res_harm_B
# 
# ### Population intercept
...
# 
# ### Subject intercept
# res_harm$Z_subj = lapply(res_harm$Z_subj_comp, function(x) uncomp_Z_subj(x,length(unique(Subj_ID)),prod(p),apply(Yvec,2,anyNA)))
# if (subj_coef_type==1) {
