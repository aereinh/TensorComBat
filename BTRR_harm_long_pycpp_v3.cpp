...
// List runMCMC_harm_long_cpp(NumericMatrix Yvec, IntegerVector p, NumericMatrix X_cov, IntegerVector Scanner_ID, IntegerVector Subj_ID, int niter, IntegerVector R, int H, bool subj_int_lowrank,
...
//                            int prog_count, bool show_all_steps, bool null_pop, bool null_scan, bool null_cov, bool null_subj) {
//   // set hyperparameters
//   // double a_lam = 1;
//   // double b_lam = 1;
//   // double a_tau = 1;
...
//   List allparams_store = initStorageVars_harm_long_cpp(Yvec, p, X_cov, Scanner_ID, Subj_ID, niter, R, H, subj_int_lowrank);
// 
